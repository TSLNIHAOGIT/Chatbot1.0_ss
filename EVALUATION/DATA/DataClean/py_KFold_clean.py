...
if __name__ == '__main__':
    ...
    file_data='IfKnowDebtor'#'WillingToPay/ConfirmLoan/CutDebt/IDClassifier/IfKnowDebtor/Installment'
    read_path=r'/Users/ozintel/Downloads/Tsl_work_file/Collect_project_file/chatbot/cmc/数据清洗2018_7_31/cleaned_data_2018_8_2/clean_first/cleaned_data/submit/{}.csv'.format(file_data)

    
    label_col = 'new_label'
    pred_col = 'predict_label'
    # saving_path = 'report/{}_Kfold_report.csv'.format(model)
    saving_path=r'/Users/ozintel/Downloads/Tsl_work_file/Collect_project_file/chatbot/cmc/数据清洗2018_7_31/cleaned_data_2018_8_2/clean_first/cleaned_data/check/{}.xls'.format(file_data)
    ...
    report.to_excel(saving_path, encoding='utf8', index=False)